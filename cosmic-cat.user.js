...
// @updateURL    https://raw.githubusercontent.com/minguinmyoui/cosmic-cat/main/cosmic-cat.user.js
// @downloadURL  https://raw.githubusercontent.com/minguinmyoui/cosmic-cat/main/cosmic-cat.user.js
// @match        https://www.youtube.com/*
// @exclude      https://www.youtube.com/embed/*
// @exclude      https://www.youtube.com/live_chat*
// @icon         https://github.com/minguinmyoui/cosmic-cat-branding/raw/main/icon.png
// @require      https://github.com/minguinmyoui/cosmic-cat/raw/main/modules/yabai_component.js
// @require      https://github.com/minguinmyoui/cosmic-cat/raw/main/modules/open_uix_components.js
...
document.cosmicCat = {
    data: {
        ...
        i18nfolder: "https://raw.githubusercontent.com/minguinmyoui/cosmic-cat-i18n/main/i18n/",
...
View the rest on Github: <a href="https://github.com/minguinmyoui/cosmic-cat">minguinmyoui/cosmic-cat</a>
    ...
    const obj = {
        setTranslation: function (params) {
            return fetch(document.cosmicCat.data.i18nfolder + `${params}.json`)
                ...
                .catch((error) => {
                alert(params + " is not translated yet.\n\nContribute: https://github.com/minguinmyoui/cosmic-cat-i18n");
...
document.cosmicCat.Utils.waitForElm("ytd-app").then(async (e) => {
    ...
    fetch("https://raw.githubusercontent.com/minguinmyoui/cosmic-cat/main/cosmic-cat.user.js").then(a => a.text()).then(a => {
    ...
    fetch("https://raw.githubusercontent.com/minguinmyoui/cosmic-cat-i18n/main/version.json").then(a => a.json()).then(a => {
...
<style id="fix-hid">.hid {display: none !important;}</style>`;
        ...
        document.cosmicCat.Utils.waitForElm2().then(() => {
            (!0 === update) && document.cosmicCat.Alert(0, "An update is available to Cosmic Cat! <a href=\"https://raw.githubusercontent.com/minguinmyoui/cosmic-cat/main/cosmic-cat.user.js\">Click to install it.</a>");
        });
